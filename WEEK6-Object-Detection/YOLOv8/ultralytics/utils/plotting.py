...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('6473FF', 'FF9D97', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
                '2C99A8', '00C2FF', '344593', 'FF3838', '0018EC', '8438FF', '520085', 'CB38FF', 'FF95C8', 'FF37C7')
        self.palette = [self.hex2rgb(f'#{c}') for c in hexs]
        self.n = len(self.palette)
        self.pose_palette = np.array([[153, 204, 255], [255, 153, 51], [255, 178, 102], [230, 230, 0], [255, 153, 255],
                                      [255, 128, 0], [255, 102, 255], [255, 51, 255], [102, 178, 255], [51, 153, 255],
